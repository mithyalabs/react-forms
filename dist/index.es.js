...
var MUISelectField = function (props) {
    ...
    if (isReadOnly) {
        return createElement(MUIReadOnly, { label: label, value: value });
    }
...
var MUIFieldArray = function (props) {
    ...
    return (React__default.createElement(FieldArray, { name: fieldProps.name, render: function (arrayHelpers) { return (React__default.createElement("div", null,
            (values || []).map(function (value, index) { return (React__default.createElement("div", { key: fieldProps.name + "-" + index, className: classes.arrayItem },
                ...
                (removeButton) ? removeButton : (React__default.createElement(IconButton, __assign({ className: classes.arrayRemoveIcon, size: "small", onClick: function () { return handleElementRemove(arrayHelpers, index); } }, removeButtonProps),
                    React__default.createElement(CloseIcon, null))))); }),
            (addButton) ? addButton : (React__default.createElement(Button, __assign({ type: "button", onClick: function () { return handleElementAdd(arrayHelpers); } }, addButtonProps), addButtonText)))); } }));
};
...
var MUIFileInput = function (props) {
    ...
    return React__default.createElement(React__default.Fragment, null,
        ...
        !!errorText ? React__default.createElement(FormHelperText, { error: true }, errorText) : null);
};
        ...
        React__default.createElement(Box, { width: "100%", display: "flex", alignItems: "flex-end" },
            React__default.createElement(Box, __assign({ width: "30%" }, countryCodeContainerProps),
                React__default.createElement(FormControl, __assign({ fullWidth: true }, countryCodeFormControlProps, { error: error }),
                    React__default.createElement(InputLabel, __assign({}, countryCodeLabelProps, { id: fieldProps.name }), countryCodeLabel || "Country code"),
...
var PlainText = function (props) {
    ...
    return (React__default.createElement(React__default.Fragment, null, isTextHtmlString && typeof text === "string" ? (React__default.createElement("div", { className: className, dangerouslySetInnerHTML: { __html: text } })) : (React__default.createElement(Typography$1, __assign({}, typographyProps), text))));
};
...
attachField("mui-plain-text", createElement(PlainText, null));
