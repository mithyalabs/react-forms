    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Box, { width: "100%", display: "flex", alignItems: "flex-end" },
            React__default.createElement(Box, __assign({ width: "30%" }, countryCodeContainerProps),
                React__default.createElement(FormControl, __assign({ fullWidth: true, error: error }, countryCodeFormControlProps),
                    React__default.createElement(InputLabel, __assign({ id: fieldProps.name }, inputLabelProps), countryCodeLabel || "Country code"),
