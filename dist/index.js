...
var MUITextField = function (props) {
    ...
    return React__default.createElement(core.TextField, __assign({}, updatedProps));
};
...
var MUISelectField = function (props) {
    ...
    return (React.createElement(core.FormControl, __assign({ error: !!fieldError }, formControlProps),
        ...
        React.createElement(core.FormHelperText, __assign({}, formHelperTextProps, { error: !!fieldError }), fieldError || helperText)));
};
...
var MUIRadio = function (props) {
    ...
    var menuOptions = getMenuOptions(options);
    var fieldError = getFieldError(fieldProps.name || '', formikProps);
    return (React.createElement(core.FormControl, __assign({ error: !!fieldError }, formControlProps, { disabled: (formControlProps === null || formControlProps === void 0 ? void 0 : formControlProps.disabled) || isReadOnly }),
...
var MUIFieldArray = function (props) {
    ...
    return (React__default.createElement(formik.FieldArray, { name: fieldProps.name, render: function (arrayHelpers) { return (React__default.createElement("div", null,
            (values || []).map(function (value, index) { return (React__default.createElement("div", { key: fieldProps.name + "-" + index, className: classes.arrayItem },
                ...
                (removeButton) ? removeButton : (React__default.createElement(core.IconButton, __assign({ className: classes.arrayRemoveIcon, size: "small", onClick: function () { return handleElementRemove(arrayHelpers, index); } }, removeButtonProps),
                    React__default.createElement(CloseIcon, null))))); }),
            (addButton) ? addButton : (React__default.createElement(core.Button, __assign({ type: "button", onClick: function () { return handleElementAdd(arrayHelpers); } }, addButtonProps), addButtonText)))); } }));
};
        ...
        React__default.createElement(core.Box, { width: "100%", display: "flex", alignItems: "flex-end" },
            React__default.createElement(core.Box, __assign({ width: "30%" }, countryCodeContainerProps),
                React__default.createElement(core.FormControl, __assign({ fullWidth: true }, countryCodeFormControlProps, { error: error }),
                    React__default.createElement(core.InputLabel, __assign({}, countryCodeLabelProps, { id: fieldProps.name }), countryCodeLabel || "Country code"),
