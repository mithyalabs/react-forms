            ...
            React__default.createElement(core.Box, { width: '15%' },
                React__default.createElement(core.FormControl, __assign({ fullWidth: true }, countryCodeFormControlProps),
                    ...
                    React__default.createElement(core.Select, __assign({ labelId: fieldProps.name, value: code, onChange: codeChange }, countryCodeProps), COUNTRY_LIST.map(function (country) {
                        return React__default.createElement(core.MenuItem, { key: country.dial_code, value: country.dial_code }, " " + country.dial_code + " (" + country.name + ")");
                    })))),
...
function ReactForm(props) {
    ...
    return (React.createElement(formik.Formik, __assign({ innerRef: innerRef, initialValues: initialValues, onSubmit: onSubmit }, formikProps), function (formProps) { return (React.createElement(MLFormBuilder, { schema: config, formId: formId, actionConfig: actionConfig, settings: __assign(__assign({}, formSettings), { isReadOnly: isReadOnly }), formikProps: formProps, isInProgress: isInProgress })); }));
}
